...
const PrescriptionButtons = ({ route,navigation }) => {
  ...
  const SickLeave = language === 'en' ? 'Prescription Reports' : 'طلب وصفة طبية';
  const SickLeaveRecords = language === 'en' ? 'Prescription Records' : 'وصفة طبية';
  const SickLeaveRequest = language === 'en' ? 'Request Prescription' : 'طلب وصفة طبية';
