...
const MedicalReportsbuttons = ({ route,navigation }) => {
  ...
  const SickLeave = language === 'en' ? 'Medical Reports' : 'تقرير طبي';
  const SickLeaveRecords = language === 'en' ? 'Medical Records' :  'تقرير طبي';
  const SickLeaveRequest = language === 'en' ? 'Request Medical Records' : 'طلب تقرير طبي';
    ...
    <Modal
      ...
      <View style={styles.buttonSection}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('MedicalReportsRequest')}
        >
        ...
        <TouchableOpacity 
          style={[styles.button, styles.greenBackground]} 
          onPress={() =>navigation.navigate('MedicalReports', { childId: childId })}
        >
...
export default MedicalReportsbuttons;
